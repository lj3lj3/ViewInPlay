...
public class Common {
    ...
    public static final String KEY_SYSTEM_APP_INFO_OPTION = "system_app_info";
    ...
    public static final String REMOVE_NOTIFICATION_RESTORE = THIS_PACKAGE_NAME
            + ".REMOVE_NOTIFICATION_RESTORE.";
